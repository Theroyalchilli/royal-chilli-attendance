...
export default function Shell({
  ...
  const active = (href: string) =>
    pathname === href || (href !== "/admin" && href !== "/me" && pathname.startsWith(href));
    ...
    <div className="min-h-dvh bg-neutral-50 md:flex">
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="absolute inset-y-0 left-0 flex w-64 flex-col bg-brand-dark text-white shadow-xl">
