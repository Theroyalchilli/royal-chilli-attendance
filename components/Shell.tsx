      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-neutral-200 bg-white px-4 py-3">
          ...
          <div className="relative">
            ...
            {menuOpen && (
              <div className="absolute left-0 z-50 mt-2 w-52 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-lg">
          ...
          <div className="ml-auto flex items-center gap-1 sm:ml-0">
            <NotificationBell />
            <button className="grid h-9 w-9 place-items-center text-lg text-neutral-500 md:hidden" onClick={() => setNavOpen((o) => !o)} aria-label="Menu">
              ☰
            </button>
          </div>
        </header>
